...
import { HomeIcon, MenuIcon, UserIcon, XIcon, ZapIcon } from 'lucide-react';
...
const Navbar = () => {
  ...
  return (
    <header className='fixed top-8 left-0 right-0 z-50 bg-background/60 backdrop-blur-md border-b border-border py-3'>
